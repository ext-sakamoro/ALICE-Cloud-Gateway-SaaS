...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['5 device connections', 'SDF stream protocol only', 'Star topology', 'Community support'] },
  { name: 'Pro', price: '$99/mo', features: ['1,000 device connections', 'SDF + MQTT + gRPC protocols', 'Full-mesh / ring / tree topology', 'SDF delta sync', '20,000 API calls/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited devices', 'Custom protocols', 'Multi-region mesh', 'Edge compute', 'SLA 99.99%', 'Dedicated support'] },
];
